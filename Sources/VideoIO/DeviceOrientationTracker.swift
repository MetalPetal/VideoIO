...
public class DeviceOrientationTracker {
    ...
    func start() {
        ...
        motionManager.startDeviceMotionUpdates(to: queue) { [weak self] (motionData, error) in
            ...
            var deviceOrientation = strongSelf._deviceOrientation
            ...
            if strongSelf._deviceOrientation != deviceOrientation {
                strongSelf._deviceOrientation = deviceOrientation
                DispatchQueue.main.async {
                    strongSelf.deviceOrientation = deviceOrientation
                    strongSelf.delegate?.deviceOrientationUpdated(tracker: strongSelf, orientation: deviceOrientation)
                }
            }
        }
    }
